 ...
 */
final class Version20190804171843 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__comment AS SELECT id, author_id, content, published_at FROM comment');
        $this->addSql('DROP TABLE comment');
        ...
        $this->addSql('INSERT INTO comment (id, author_id, content, published) SELECT id, author_id, content, published_at FROM __temp__comment');
        $this->addSql('DROP TABLE __temp__comment');
        $this->addSql('CREATE INDEX IDX_9474526CF675F31B ON comment (author_id)');
    }
}
